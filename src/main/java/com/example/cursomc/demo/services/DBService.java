...
import com.example.cursomc.demo.domain.enums.EstadoPagamento;
import com.example.cursomc.demo.domain.enums.TipoCliente;
import com.example.cursomc.demo.repositories.CategoriaRepository;
import com.example.cursomc.demo.repositories.CidadeRepository;
import com.example.cursomc.demo.repositories.ClienteRepository;
import com.example.cursomc.demo.repositories.EnderecoRepository;
import com.example.cursomc.demo.repositories.EstadoRepository;
import com.example.cursomc.demo.repositories.ItemPedidoRepository;
import com.example.cursomc.demo.repositories.PagamentoRepository;
import com.example.cursomc.demo.repositories.PedidoRepository;
...
public class DBService 
{
	...
	public void instantiateDatabase() throws ParseException
	{
		...
		Produto p4 = new Produto(null, "Mesa de Escrtório", 300);
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "xjujuba206x@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));
